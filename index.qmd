...
Here, we can download the full data ('sexism\_data.csv') and put it in folder called 'sexism_data' in the same location as our jupyter notebook. Here, we will use just a subset of the data ('sexism_sample.csv') for demonstration.
